...
WALLET_ROOT=$$PWD/shangcoin

CONFIG += c++11

# cleaning "auto-generated" shangcoin directory on "make distclean"
...
linux {
   ...
   #     }
    ...
    # currently shangcoin has an issue with "static" build and linunwind-dev,
...
TRANSLATIONS =  \ # English is default language, no explicit translation file
                $$PWD/translations/shangcoin-core.ts \ # translation source (copy this file when creating a new translation)
                $$PWD/translations/shangcoin-core_ar.ts \ # Arabic
                $$PWD/translations/shangcoin-core_pt-br.ts \ # Portuguese (Brazil)
                $$PWD/translations/shangcoin-core_de.ts \ # German
                $$PWD/translations/shangcoin-core_eo.ts \ # Esperanto
                $$PWD/translations/shangcoin-core_es.ts \ # Spanish
                $$PWD/translations/shangcoin-core_fi.ts \ # Finnish
                $$PWD/translations/shangcoin-core_fr.ts \ # French
                $$PWD/translations/shangcoin-core_hr.ts \ # Croatian
                $$PWD/translations/shangcoin-core_id.ts \ # Indonesian
                $$PWD/translations/shangcoin-core_hi.ts \ # Hindi
                $$PWD/translations/shangcoin-core_it.ts \ # Italian
                $$PWD/translations/shangcoin-core_ja.ts \ # Japanese
                $$PWD/translations/shangcoin-core_nl.ts \ # Dutch
                $$PWD/translations/shangcoin-core_pl.ts \ # Polish
                $$PWD/translations/shangcoin-core_ru.ts \ # Russian
                $$PWD/translations/shangcoin-core_sv.ts \ # Swedish
                $$PWD/translations/shangcoin-core_zh-cn.ts \ # Chinese (Simplified-China)
                $$PWD/translations/shangcoin-core_zh-tw.ts \ # Chinese (Traditional-Taiwan)
                $$PWD/translations/shangcoin-core_he.ts \ # Hebrew
                $$PWD/translations/shangcoin-core_ko.ts \ # Korean
...
android{
    deploy.commands += make install INSTALL_ROOT=$$DESTDIR && androiddeployqt --input android-libshangcoin-wallet-gui.so-deployment-settings.json --output $$DESTDIR --deployment bundled --android-platform android-21 --jdk /usr/lib/jvm/java-8-openjdk-amd64 -qmldir=$$PWD
}
...
DISTFILES += \
    notes.txt \
    shangcoin/src/wallet/CMakeLists.txt \
    components/MobileHeader.qml


# windows application icon
RC_FILE = shangcoin-wallet-gui.rc
