...
public:
    enum LogLevel {
        LogLevel_Silent = Shangcoin::WalletManagerFactory::LogLevel_Silent,
        LogLevel_0 = Shangcoin::WalletManagerFactory::LogLevel_0,
        LogLevel_1 = Shangcoin::WalletManagerFactory::LogLevel_1,
        LogLevel_2 = Shangcoin::WalletManagerFactory::LogLevel_2,
        LogLevel_3 = Shangcoin::WalletManagerFactory::LogLevel_3,
        LogLevel_4 = Shangcoin::WalletManagerFactory::LogLevel_4,
        LogLevel_Min = Shangcoin::WalletManagerFactory::LogLevel_Min,
        LogLevel_Max = Shangcoin::WalletManagerFactory::LogLevel_Max,
    };
...
private:
    ...
    Shangcoin::WalletManager * m_pimpl;
    QMutex m_mutex;
