...
public:
    enum Direction {
        Direction_In  =  Shangcoin::TransactionInfo::Direction_In,
        Direction_Out =  Shangcoin::TransactionInfo::Direction_Out,
...
private:
    explicit TransactionInfo(Shangcoin::TransactionInfo * pimpl, QObject *parent = 0);
private:
    friend class TransactionHistory;
    Shangcoin::TransactionInfo * m_pimpl;
