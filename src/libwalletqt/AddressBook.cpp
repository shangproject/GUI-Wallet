...
AddressBook::AddressBook(Shangcoin::AddressBook *abImpl,QObject *parent)
...
QList<Shangcoin::AddressBookRow*> AddressBook::getAll(bool update) const
{
    qDebug(__FUNCTION__);
...
Shangcoin::AddressBookRow * AddressBook::getRow(int index) const
{
